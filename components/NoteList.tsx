...
export default function NoteList({data}:{data:string}) {
            ...
            <div className="w-full max-w-3xl mx-auto px-3 sm:px-4">
                <div className="card p-4 sm:p-6 text-center">
                    <div className="text-red-500 dark:text-red-400 mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 sm:h-10 sm:w-10 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <button
                        className="mt-4 btn btn-primary w-full sm:w-auto"
    ...
    return (
        <div className="w-full max-w-3xl mx-auto px-3 sm:px-4 pb-6 sm:pb-8">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-800 dark:text-white mb-3 sm:mb-4">Your Notes</h2>
